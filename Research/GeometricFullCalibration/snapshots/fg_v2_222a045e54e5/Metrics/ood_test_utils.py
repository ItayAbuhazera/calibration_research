...
def get_roc_auc(net, test_loader, ood_test_loader, device):
    ...
    # Check if tensors are not None before processing
    if bin_labels_entropies is not None and entropies is not None and bin_labels_confidences is not None and confidences is not None:
        ...
        auc_entropy, auc_confidence = 0.0, 0.0
