# Data/cifar100_augmix.py
"""
CIFAR-100 data loader with AugMix support
"""
...
class CIFAR100AugMix(Dataset):
    """CIFAR-100 dataset that returns AugMix triplets"""
    ...
    def __getitem__(self, idx):
        ...
        if self.augmix_transform:
            ...
            # Fallback to standard transform (use CIFAR-100 normalization)
...
def get_augmix_loaders(batch_size, random_seed, valid_size=0.1, augmix_transform=None):
    """Get AugMix training and validation loaders for CIFAR-100"""
    from torch.utils.data.sampler import SubsetRandomSampler
    
    # Create dataset
    train_dataset = CIFAR100AugMix(
        root='./data', 
        train=True, 
        augmix_transform=augmix_transform
    )
    
    val_dataset = CIFAR100AugMix(
        root='./data',
        train=True,
